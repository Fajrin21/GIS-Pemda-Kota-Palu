        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="pertanahan.php" class="active">Pertanahan</a></li>
            </nav><!-- .navbar -->
            ...
            <div class="container">
                <div class="row gy-4 d-flex justify-content-between">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">Pemda Kota Palu
                        </p>
                    </div>
                </div>
        </section>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-striped table-admin">
                            ...
                            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-row justify-content-center mb-4">
                                <form action="#" class="form-search flex items-center mb-3" data-aos="fade-up"
                                    data-aos-delay="200">
